...
public class CalculatorParser extends Parser {
	...
	public static final int
		T__0=1, T__1=2, MUL=3, DIV=4, ADD=5, SUB=6, ASSIGN=7, ID=8, INT=9, NEWLINE=10, 
		WS=11;
	public static final int
		RULE_program = 0, RULE_statement = 1, RULE_assign = 2, RULE_expr = 3, 
		RULE_term = 4, RULE_factor = 5;
	private static String[] makeRuleNames() {
		return new String[] {
			"program", "statement", "assign", "expr", "term", "factor"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, null, null, "MUL", "DIV", "ADD", "SUB", "ASSIGN", "ID", "INT", 
			"NEWLINE", "WS"
		};
	}
	...
	public static class AssignmentStatementContext extends StatementContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CalculatorVisitor ) return ((CalculatorVisitor<? extends T>)visitor).visitAssignmentStatement(this);
			else return visitor.visitChildren(this);
		}
	}
	@SuppressWarnings("CheckReturnValue")
	public static class ExprStatementContext extends StatementContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof CalculatorListener ) ((CalculatorListener)listener).enterExprStatement(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof CalculatorListener ) ((CalculatorListener)listener).exitExprStatement(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CalculatorVisitor ) return ((CalculatorVisitor<? extends T>)visitor).visitExprStatement(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class AssignContext extends ParserRuleContext {
		...
		public AbstractButton ID() {
			return (AbstractButton) getToken(CalculatorParser.ID, 0);
		}
	...
	public static class AssignmentContext extends AssignContext {
		public AbstractButton ID() { return (AbstractButton) getToken(CalculatorParser.ID, 0); }
	...
	@SuppressWarnings("CheckReturnValue")
	public static class AddSubContext extends TermContext {
		public Character op;
		...
		public AddSubContext(TermContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
